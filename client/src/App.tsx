...
function App() {
  ...
  const user =
    currentUserQuery.data && !currentUserQuery.isError ? currentUserQuery.data : undefined;
  ...
  return (
    <>
      <AppBar position="fixed">
        <Toolbar>
          <CameraIcon onClick={() => navigate(routes.home)} sx={{ mr: 2 }} />
          <Typography
          ...
          {user ? (
            <>
              <PersonIcon onClick={() => navigate(routes.profile)} />
              <Typography
